...
class ViewMod(private val mainRepository: CountryRepo, private val devRepo: DevRepo, private val shP: SharedPreferences, val application: Application): ViewModel() {
    ...
    fun convers(cont: Context) {
        AppsFlyerLib.getInstance()
            .init("kVfYLazrP6hD2mH2PaR3AT", conversionDataListener, application)
