...
import com.alchemist.angelsagao.MenuMainHubAct
import com.alchemist.angelsagao.R
import com.alchemist.angelsagao.TrueLibertyAwaits
...
class FragmentPiat : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_piat, container, false)
    }
    ...
    override fun onStart() {
        ...
        val pack = "com.alchemist.angelsagao"
        ...
        val intentBeam = Intent(mContext, TrueLibertyAwaits::class.java)
        val intentGame = Intent(mContext, MenuMainHubAct::class.java)
